...
public class NfvNFFG {
    ...
    protected List<NfvNFFG.NfvNode> nfvNode;
    protected Link self;
     ...
     * {@link NfvNFFG.NfvNode }
     * 
     * 
     */
    public List<NfvNFFG.NfvNode> getNfvNode() {
        if (nfvNode == null) {
            nfvNode = new ArrayList<NfvNFFG.NfvNode>();
        }
        return this.nfvNode;
    }
    ...
    public static class NfvNode {
        ...
        @XmlElement(nillable = true)
        protected List<NfvNFFG.NfvNode.NfvArc> nfvArc;
        protected Link self;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link NfvNFFG.NfvNode.NfvArc }
         * 
         * 
         */
        public List<NfvNFFG.NfvNode.NfvArc> getNfvArc() {
            if (nfvArc == null) {
                nfvArc = new ArrayList<NfvNFFG.NfvNode.NfvArc>();
            }
            return this.nfvArc;
        }
