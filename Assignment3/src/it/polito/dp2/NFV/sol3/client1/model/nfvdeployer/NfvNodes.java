...
public class NfvNodes {
    ...
    protected List<NfvNodes.NfvNode> nfvNode;
     ...
     * {@link NfvNodes.NfvNode }
     * 
     * 
     */
    public List<NfvNodes.NfvNode> getNfvNode() {
        if (nfvNode == null) {
            nfvNode = new ArrayList<NfvNodes.NfvNode>();
        }
        return this.nfvNode;
    }
    ...
    public static class NfvNode {
        ...
        @XmlElement(nillable = true)
        protected List<NfvNodes.NfvNode.NfvArc> nfvArc;
        protected Link self;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link NfvNodes.NfvNode.NfvArc }
         * 
         * 
         */
        public List<NfvNodes.NfvNode.NfvArc> getNfvArc() {
            if (nfvArc == null) {
                nfvArc = new ArrayList<NfvNodes.NfvNode.NfvArc>();
            }
            return this.nfvArc;
        }
